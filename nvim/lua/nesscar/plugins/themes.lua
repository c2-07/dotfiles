  ...
  -- ============================================================================
  {
    ...
    config = function()
      ...
      vim.api.nvim_create_user_command("ThemeSelect", function()
        ...
        local ignored = { "blue", "darkblue", "default", "delek", "desert", "elflord", "evening", "industry", "koehler",
          "morning", "murphy", "pablo", "peachpuff", "ron", "shine", "slate", "torte", "quiet", "vim", "lunaperche",
          "habamax", "zaibatsu", "retrobox", "sorbet", "wildcharm", "zellner", "unokai", "random" }
